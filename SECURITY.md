...
The following versions of FlowWarden Redis receive security updates:
...
We take the security of FlowWarden Redis seriously. If you believe you have found a security vulnerability, please report it responsibly through one of the following channels.
...
[https://github.com/flowwarden-io/flowwarden-redis/security/advisories/new](https://github.com/flowwarden-io/flowwarden-redis/security/advisories/new)
...
- The affected version(s) of FlowWarden Redis
...
The following are generally not considered security vulnerabilities in FlowWarden Redis itself:
...
- Configuration issues in user deployments (insufficient Redis authentication, exposed credentials, missing TLS, etc.)

Thank you for helping keep FlowWarden Redis and its users safe.
