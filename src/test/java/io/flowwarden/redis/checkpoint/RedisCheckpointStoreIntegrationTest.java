...
class RedisCheckpointStoreIntegrationTest extends CheckpointStoreContractTest {
    ...
    void resetAfterHistoryLost_guardMatch_runsInPlace_preservingUnknownFields() {
        ...
        template.opsForHash().put("test:checkpoint:lua-s", "customField", "keep-me");
        ...
        assertThat(template.opsForHash().get("test:checkpoint:lua-s", "customField"))
    ...
    void resetAfterHistoryLost_guardMismatch_preservesProcessedAndUnknownFields() {
        ...
        template.opsForHash().put("test:checkpoint:lua-s2", "customField", "keep-me");
        ...
        assertThat(found.lastProcessedToken())
                ...
                .isEqualTo(current);
        assertThat(found.lastSeenToken()).isEqualTo(fresh);
        assertThat(template.opsForHash().get("test:checkpoint:lua-s2", "customField"))
                .isEqualTo("keep-me");
    }
}
